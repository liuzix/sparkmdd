...
import unsafe.BitSet;
import unsafe.UnsafeWrapper;
import static unsafe.UnsafeWrapper.BYTE_ARRAY_OFFSET;
...
public final class UnsafeGenericHandle {
  ...
  public UnsafeGenericHandle(int numFields) {
    this.numFields = numFields;
    this.bitSetWidthInBytes = calculateBitSetWidthInBytes(numFields);
    this.pointTo(new byte[sizeInBytes], numBytes);
  }
